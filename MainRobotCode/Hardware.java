...
public class Hardware {
	...
	//Servos for Knuckles 
	public Servo LKnuckle = null;
	public Servo RKnuckle = null;
	...
	public void init() {
		...
		LKnuckle = myOpMode.hardwareMap.get(Servo.class, "LeftKnuckle");
		RKnuckle = myOpMode.hardwareMap.get(Servo.class, "RightKnuckle");
