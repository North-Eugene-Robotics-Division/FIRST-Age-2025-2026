...
// INTAKE_MIN INTAKE_MIL INTAKE_MID INTAKE_MAX LAUNCH_PRIMER_MIN
// LAUNCH_PRIMER_MID LAUNCH_PRIMER_MAX LAUNCH_PRIMER_TEST
// FLIPPER_MIN FLIPPER_MID FLIPPER_MAX
flipper.setPosition(FLIPPER_MAX);
sleep(2000);
intake.setPosition(INTAKE_MIN);
sleep(100);
launchPrimer.setPosition(LAUNCH_PRIMER_MIN); // THIS IS NOT MOVING CHECK CONFIG
